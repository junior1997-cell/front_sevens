...
<html lang="es">
  ...
  <body>
    <span class="name_page" style="display: none;" >Servicios</span>
    <!-- ========== HEADER ========== -->
    ...
    <main id="content" role="main">
      ...
      <div class="container space-top-3 space-top-lg-4">
        ...
        <div class="w-lg-65 text-center mx-lg-auto mb-5 mb-md-9">
          <h1>Servicios.</h1>
          <p>Conozca nuestros servicios y comprenderá por qué la empresa SEVEN’S INGENIEROS S.A.C es mucho más que una simple empresa constructora.</p>
        </div>
        <!-- End Title -->

        <div class="row">
          <div class="col-md-5 align-self-md-end mb-3 mb-md-0">
            <img class="img-fluid rounded-lg" src="assets/img/servicios/img11.jpg" alt="Image Description">
          </div>
          ...
          <!-- <div class="col-md-4 mb-3 mb-md-0 mb-md-n11">-->
            ...
            <!-- <a class="card text-center h-100 transition-3d-hover">
              <div class="card-body p-lg-5">
                ...
                <h3 class="h4">EJECUCIÓN DE OBRAS</h3>
                <p class="text-body text-justify mb-0">Disponemos del mejor equipo de técnicos y profesionales 
                  ...
                  <div class="card-body p-5">
                    <div class="">
                      ...
                      <div class="">
                        ...
                        <!-- End SVG Quote -->
                        <!-- Text -->
                        <blockquote class="text-dark text-lh-lg mb-4 text-justify">Se tú , un cliente feliz por el servicio de calidad que la 
                          empresa SEVEN’S INGENIEROS S.A.C brinda que van acorde a tus requerimientos y necesidades.!!!</blockquote>
                        <!-- End Text -->
                      </div>
                      <!-- End Testimonials -->
                    </div>
