  ...
  $.post("../ajax/servicios.php?op=mostrar_servicio", { idservicio: idservicio }, function (data, status) {
    ...
    if (data.data.img_perfil == "" || data.data.img_perfil == null  ) {
      ...
      if ( extrae_extencion(data.data.img_perfil) == "pdf" ) {
        ...
        $("#doc1_ver").html('<iframe src="../dist/img/servicios/imagen_perfil/'+data.data.img_perfil+'" frameborder="0" scrolling="no" width="100%" height="210"> </iframe>');
        ...
        if (
          ...
          $("#doc1_ver").html(`<img src="../dist/img/servicios/imagen_perfil/${data.data.img_perfil}" alt="" width="100%" onerror="this.src='../dist/svg/error-404-x.svg';" >`); 
      ...
      if ( extrae_extencion(antiguopdf) == "doc") {
        ...
        if ( extrae_extencion(antiguopdf) == "docx" ) {
          ...
          if ( extrae_extencion(antiguopdf) == "pdf" ) { 
            $("#doc"+id+"_ver").html(`<iframe src="../dist/dist/img/servicios/${carpeta}/${antiguopdf}" frameborder="0" scrolling="no" width="100%" height="310"></iframe>`);
                ...
                if ( extrae_extencion(antiguopdf) == "xlsx" ) {
                  ...
                  if ( extrae_extencion(antiguopdf) == "xlsm" ) {
                    ...
                    if (
                      ...
                      $("#doc"+id+"_ver").html(`<img src="../dist/img/servicios/${carpeta}/${antiguopdf}" alt="" onerror="this.src='../dist/svg/error-404-x.svg';" width="100%" >`);
                      toastr.success('Documento vizualizado correctamente!!!');
                    } else {
