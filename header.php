      ...
      <div class="d-flex align-items-center">
        ...
        <div class="hs-unfold">
          <a class="js-hs-unfold-invoker dropdown-nav-link dropdown-toggle d-flex align-items-center" href="javascript:;"
            ...
            <img class="dropdown-item-icon mr-2" src="assets/vendor/flag-icon-css/flags/1x1/pe.svg" alt="SVG">
            <span class="d-inline-block d-sm-none">ES</span>
            <span class="d-none d-sm-inline-block">Español Perú</span>
          </a>
          ...
          <div class="navbar-body header-abs-top-inner">
            <ul class="navbar-nav">
              ...
              <li class="navbar-nav-last-item">
                <a class="btn btn-sm btn-primary transition-3d-hover" href="https://themes.getbootstrap.com/product/front-multipurpose-responsive-template/" target="_blank">Ver precios</a>
              </li>
              <!-- End Button -->
            </ul>
          </div>
